...
void type_add_field(var_type* s, char* name, var_type* type) {
    my_assert("parser/types.c", 61, "s != NULL", s != 0);
    my_assert("parser/types.c", 62, "s->base == LANG_STRUCT", s->base == LANG_STRUCT);
...
t_struct_field* type_get_field(var_type* s, char* name) {
    my_assert("parser/types.c", 75, "s != NULL", s != 0);
    my_assert("parser/types.c", 76, "s->base == LANG_STRUCT", s->base == LANG_STRUCT);
...
void type_print(var_type* v) {
    my_assert("parser/types.c", 99, "v != NULL", v != 0);
