...
UTIL_DEPS = util/list.h util/stack.h util/queue.h util/hash.h util/xerror.h
UTIL_OBJS = util/list.o util/stack.o util/queue.o util/hash.o util/xerror.o
...
my_cc:
	...
	ld -lc obj/util/list.o obj/util/queue.o obj/util/hash.o obj/util/stack.o obj/util/xerror.o \
		obj/tokenizer/tokens.o obj/tokenizer/tokenize.o \
		obj/incmain.o obj/token_q.o obj/contracts.o \
		obj/parser/ast.o obj/parser/parser.o \
		obj/parser/types.o  obj/parser/scope.o \
...
my_my_cc:
	...
	ld -lc obj2/util/list.o obj2/util/queue.o obj2/util/hash.o obj2/util/stack.o obj2/util/xerror.o \
